$(document).ready( function(){ 
	...
	$('#form_mantenimiento').on('submit', guardarRegistro );
...
function listarRegistros(){
	...
	return $.ajax({
		url: 'consultas/lista_mantenimiento.php',
...
function guardarRegistro(event){
	...
	$.ajax({
		url: 'consultas/guardar_mantenimiento.php',
		method: 'POST',
		dataType: 'JSON',
		data: datos
		}).done(function(respuesta){
...
function imprimirTicket(event){
	...
	$.ajax({
		url: "impresion/imprimir_mantenimiento.php",
		data:{
			folio : folio
		}
		}).done(function (respuesta){
...
function confirmaCancelacion(event){
	...
	function cancelarRegistro(){
		...
		return $.ajax({ 
			url: "consultas/cancelar_mantenimiento.php",
			dataType:"JSON",
			data:{
				folio : folio
			}
