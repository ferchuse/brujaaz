		 ...
		 <div class="modal-content">
		   ...
		   <!-- Modal body -->
			<div class="modal-body">
				<input type="text" hidden class="form-control" id="id_tipo_mantenimiento" name="id_tipo_mantenimiento">
				<div class="form-group">
					<label for="nombre_propietarios">Tipo de Mantenimiento</label>
