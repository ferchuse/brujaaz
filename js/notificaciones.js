...
$(document).ready(function (){
	console.log("notificaciones.js ready");
	$('.dropdown-menu option, .dropdown-menu select').click(function(e) {
		e.stopPropagation();
	});
	
	
	$("#silent_print").change(function cambiarSilentPrint(){
		
		$.ajax({
			"url": "../../funciones/cambiar_silent_print.php",
			"method": "post",
			"data": {"silent_print" : $("#silent_print").val()}
